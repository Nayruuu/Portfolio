...
- `.claude/agents/{angular-dev,angular-reviewer,article-writer,claude-auditor,level-designer}.md` — the project sub-agents.
- `.claude/commands/journal.md` — the project command.
