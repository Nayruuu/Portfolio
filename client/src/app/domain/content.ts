...
/**
 * The bilingual content contract. Typing both `content.{fr,en}.ts` bridges as `Content`
 * guarantees FR and EN stay structurally aligned at compile time. Holds both UI micro-copy
