 ...
 * no ledge baked in (the real geometry shows through). Engine-agnostic — blitted by {@link ClimbView}
 * for the BSP renderer; preloaded so they never pop in mid-climb.
 */
