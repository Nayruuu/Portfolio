...
export interface PickupZone {
  ...
  applyFlicker(flickers: readonly Flicker[], sectors: MutableSector[], timeMs: number): void;
}
...
export class PickupRuntime {
  ...
  private flash = 0;
  private hintClock = 0;
  private flickerMs = 0; // monotonic buzz clock, advanced alongside the door step
  ...
  public stepDoors(dt: number): void {
    ...
    this.hooks.zone.applyFlicker(world.flickers, world.sectors, this.flickerMs);
  }
