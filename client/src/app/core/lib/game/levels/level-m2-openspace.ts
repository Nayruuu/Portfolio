...
function buildMap(): { map: MapSource; gateSector: number; secretSector: number } {
  ...
  const cubicle = { floorZ: 1.3, ceilZ: 4.8, floorTex: 'STEP', ceilTex: 'CONCRETE', light: 113 };
  ...
  const MEZZ = b.room(
    ...
    { ...UPPER, ceilZ: 5.6, light: 126, wallTex: 'CUBICLE' },
  );
  ...
  const office = { ...UPPER, ceilZ: 5.6, light: 203, wallTex: 'CUBICLE' };
  ...
  const ring = { ...GROUND, ceilZ: 4.2, light: 123, wallTex: 'CUBICLE' };
  const RN = b.room(
  ...
  const PIT = b.room(
    ...
    { floorZ: -1.2, ceilZ: 4.2, floorTex: 'TILE', ceilTex: 'NEON', light: 168, wallTex: 'METAL' },
  );
  ...
  const neck = { ...GROUND, ceilZ: 3.0, light: 103, wallTex: 'CUBICLE' };
