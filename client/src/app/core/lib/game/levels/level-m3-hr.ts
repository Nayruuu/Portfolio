...
function buildMap(): {
  ...
  b.island(ACCUEIL, rect(88, 10, 100, 13), { ...counter, light: 193, wallTex: 'RECEPTION' });
  const bench = { floorZ: 0.5, ceilZ: 4.6, floorTex: 'STEP', ceilTex: 'TECHNICAL', light: 193 };
  ...
  const booth = { ...GROUND, ceilZ: 3.2, light: 193, wallTex: 'CUBICLE' };
  ...
  const cabinet = { floorZ: 1.3, ceilZ: 5.6, floorTex: 'STEP', ceilTex: 'TECHNICAL', light: 136 };
  ...
  const office = { ...UPPER, ceilZ: 5.2, light: 193, wallTex: 'CUBICLE' };
  ...
  const rim = { ...GROUND, ceilZ: 4.6, light: 103, wallTex: 'CUBICLE' };
  ...
  const PIT = b.room(
    ...
    { floorZ: -1.6, ceilZ: 4.6, floorTex: 'TILE', ceilTex: 'NEON', light: 193, wallTex: 'SCREEN' },
  );

  b.connect(PIT, RIMN, { tex: 'SCREEN' });
  b.connect(PIT, RIMW, { tex: 'SCREEN' });
  b.connect(PIT, RIME, { tex: 'SCREEN' });
  const pitRun = { depth: 1, count: 3, zBase: -1.6, dz: 0.4, ceilZ: 4.6, light: 108 };
