...
function buildMap(): {
  ...
  b.island(FOYER, rect(42, 53, 45, 59), { ...counter, light: 196, wallTex: 'RECEPTION' });
  const bench = { floorZ: 0.5, ceilZ: 5.2, floorTex: 'STEP', ceilTex: 'TECHNICAL', light: 196 };
  ...
  const gallery = { floorZ: 1.6, ceilZ: 7.2, floorTex: 'STEP', ceilTex: 'TECHNICAL', light: 113 };
  ...
  const bocal = { ...GROUND, ceilZ: 3.2, light: 196, wallTex: 'SCREEN' };
  ...
  b.island(B1, rect(91.5, 40, 95.5, 42), { ...table, ceilZ: 3.2, light: 196 });
  b.island(B2, rect(103, 31, 106, 33), { ...table, ceilZ: 3.2, light: 196 });
  ...
  b.island(EVEREST, rect(88, 3, 98, 6.5), { ...table, ceilZ: 4.2, light: 196 });
  ...
  const tier = { ceilZ: 5.6, floorTex: 'CARPET', ceilTex: 'TECHNICAL', light: 103 };
