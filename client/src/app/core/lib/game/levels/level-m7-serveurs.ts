...
function buildMap(): {
  ...
  b.island(NOC, rect(78, 14, 86, 16), { ...desk, light: 183, wallTex: 'METAL' });
  b.island(NOC, rect(78, 20, 86, 22), { ...desk, light: 183, wallTex: 'METAL' });
  ...
  const walk = { ...HALL, ceilZ: 3.2, light: 108, wallTex: 'METAL' };
...
export const M7_SERVEURS: Level = {
  ...
  // Failing tubes: the cable gallery (lit only by the shaft's spill) and a NEON hot aisle buzz + drop out.
  flicker: [built.galeSector, built.hanSector],
};
