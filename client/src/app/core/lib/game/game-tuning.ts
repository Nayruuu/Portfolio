...
// Right-thumb look drag: px dragged × this = radians swept. Coarser than MOUSE_SENS because a thumb
// travels far less than a mouse — a ~180px swipe sweeps close to a quarter-turn.
export const TOUCH_LOOK_SENS = 0.005;

// Left-thumb floating joystick: full analog deflection is reached this many px from the touch origin;
// a throw whose magnitude is under DEADZONE (a fraction of full) reads neutral so a resting thumb never creeps.
...
export const PICKUP_VOX_SPIN = Math.PI / 2; // rad/s
