 ...
 * deployable to Azure Static Web Apps). The parameterized detail routes enumerate
 * their slugs; `**` covers the explicit static pages (`/fr`, `/en`, `/fr/about`, …).
 */
export const serverRoutes: ServerRoute[] = [
  ...
  { path: 'fr/series/:slug', renderMode: RenderMode.Prerender, getPrerenderParams: seriesParams },
  { path: 'en/series/:slug', renderMode: RenderMode.Prerender, getPrerenderParams: seriesParams },
