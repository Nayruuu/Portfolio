 ...
 *
 * Usage:
 *   node scripts/gen-i18n.mjs en            # content + all articles, for en
 *   node scripts/gen-i18n.mjs en --content-only
 *   node scripts/gen-i18n.mjs en --slug=angular-zoneless-signals --force
 */
